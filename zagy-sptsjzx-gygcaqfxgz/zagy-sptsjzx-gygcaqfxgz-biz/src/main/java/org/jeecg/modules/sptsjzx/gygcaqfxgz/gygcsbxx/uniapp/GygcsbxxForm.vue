<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">设备信息(化工园区)</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入设备位置" v-model="model.equipmentLocation"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入设备类型" v-model="model.equipmentType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">设备状态：</text></view>
                  <input  placeholder="请输入设备状态" v-model="model.equipmentStatus"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">生产厂家：</text></view>
                  <input  placeholder="请输入生产厂家" v-model="model.equipmentFactory"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">型号：</text></view>
                  <input  placeholder="请输入型号" v-model="model.equipmentModel"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/gygcaqfxgz/gygcsbxx/gygcsbxx/queryById",
                  add: "/sptsjzx/gygcaqfxgz/gygcsbxx/gygcsbxx/add",
                  edit: "/sptsjzx/gygcaqfxgz/gygcsbxx/gygcsbxx/edit",
                },
            }
        },
        created(){
