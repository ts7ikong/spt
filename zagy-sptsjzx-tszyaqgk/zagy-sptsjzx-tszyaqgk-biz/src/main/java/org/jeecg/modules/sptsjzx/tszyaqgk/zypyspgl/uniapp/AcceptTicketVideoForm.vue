    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">作业票ID：</text></view>
                  <input  placeholder="请输入作业票ID" v-model="model.workorderId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入最后修改时间" v-model="model.updateTime"/>
                </view>
              </view>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/tszyaqgk/zypyspgl/acceptTicketVideo/queryById",
                  add: "/sptsjzx/tszyaqgk/zypyspgl/acceptTicketVideo/add",
