package org.jeecg.modules.sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx.controller;
...
public class VideoInfoController extends JeecgController<VideoInfo, IVideoInfoService> {
	...
	public Result<IPage<VideoInfo>> queryPageList(VideoInfo videoInfo,
		...
		if (!DataScopeHelper.needDataScope()) {
			...
			String requestCompanyCode = videoInfo.getCompanyCode();
			...
			if (videoInfo.getCountyCode() != null) {
				String orgCode = videoInfo.getCountyCode();
				List<String> companyCodes = acceptCompanyService.getCompanyCodesByCountyCode(orgCode);
		...
		if (pageList != null && CollectionUtils.isNotEmpty(pageList.getRecords())) {
			for (VideoInfo item : pageList.getRecords()) {
	...
	@RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:add")
	@PostMapping(value = "/add")
	public Result<String> add(@RequestBody VideoInfo videoInfo) {
	...
	@RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:edit")
	@RequestMapping(value = "/edit", method = {RequestMethod.PUT,RequestMethod.POST})
	public Result<String> edit(@RequestBody VideoInfo videoInfo) {
	...
	@RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:delete")
	...
	@RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:deleteBatch")
	...
	public Result<VideoInfo> queryById(@RequestParam(name="id",required=true) String id) {
    ...
    * @param videoInfo
    */
    @RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:exportXls")
    @RequestMapping(value = "/exportXls")
    public ModelAndView exportXls(HttpServletRequest request, VideoInfo videoInfo) {
        return super.exportXls(request, videoInfo, VideoInfo.class, "摄像头信息");
    }
    ...
    * @return
    */
    @RequiresPermissions("sptsjzx.qyaqjcgl.zysbsssj.jcsbxx.sxtxx:video_info:importExcel")
