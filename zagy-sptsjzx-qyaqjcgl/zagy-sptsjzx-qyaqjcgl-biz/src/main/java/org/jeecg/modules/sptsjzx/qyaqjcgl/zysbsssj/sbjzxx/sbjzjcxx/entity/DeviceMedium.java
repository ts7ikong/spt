package org.jeecg.modules.sptsjzx.qyaqjcgl.zysbsssj.sbjzxx.sbjzjcxx.entity;
 ...
 */
@Data
@TableName("device_medium")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="device_medium对象", description="设备介质基础信息")
public class DeviceMedium implements Serializable {
	...
	/**是否填写组分*/
	@Excel(name = "是否填写组分", width = 15, dicCode = "sf")
	@Dict(dicCode = "sf")
    @ApiModelProperty(value = "是否填写组分")
    private java.lang.String isFillComponent;
	/**删除标记*/
