<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">企业重点监管工艺信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/qyjbxx/qyzdjggyxx/qyzdjggyxx/queryById",
                  add: "/sptsjzx/qyaqjcgl/qyjbxx/qyzdjggyxx/qyzdjggyxx/add",
