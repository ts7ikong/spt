<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">企业隶属化工行业关系表</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">化工行业编码：</text></view>
                  <input  placeholder="请输入化工行业编码" v-model="model.chemicalIndustryCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/qyjbxx/qylshghygx/qylshghygx/queryById",
                  add: "/sptsjzx/qyaqjcgl/qyjbxx/qylshghygx/qylshghygx/add",
