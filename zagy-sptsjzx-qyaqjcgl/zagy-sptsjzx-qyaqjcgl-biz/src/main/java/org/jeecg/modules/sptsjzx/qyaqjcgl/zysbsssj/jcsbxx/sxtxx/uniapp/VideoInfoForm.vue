<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">摄像头信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">视频名称：</text></view>
                  <input  placeholder="请输入视频名称" v-model="model.videoName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">所属企业名称：</text></view>
                  <input  placeholder="请输入所属企业名称" v-model="model.companyCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">摄像头类型：</text></view>
                  <input type="number" placeholder="请输入摄像头类型" v-model="model.videoType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sxtxx/videoInfo/queryById",
                  add: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sxtxx/videoInfo/add",
                  edit: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sxtxx/videoInfo/edit",
                },
            }
        },
        created(){
