<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">化学危险品目录信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入品名" v-model="model.chemicalName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入备注" v-model="model.description"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/zysbsssj/sbjzxx/hxwxpmlxx/chemicalInfo/queryById",
                  add: "/sptsjzx/qyaqjcgl/zysbsssj/sbjzxx/hxwxpmlxx/chemicalInfo/add",
