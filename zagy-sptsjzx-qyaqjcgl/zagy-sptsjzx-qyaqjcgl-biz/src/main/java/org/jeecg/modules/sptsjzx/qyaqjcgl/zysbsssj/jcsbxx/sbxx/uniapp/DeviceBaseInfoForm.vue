			...
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input type="number" placeholder="请输入设备运行状态" v-model="model.equipStatus"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sbxx/deviceBaseInfo/queryById",
                  add: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sbxx/deviceBaseInfo/add",
                  edit: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/sbxx/deviceBaseInfo/edit",
                },
            }
        },
        created(){
