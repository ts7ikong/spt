<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">企业隶属重点行业关系</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">重点行业编码：</text></view>
                  <input  placeholder="请输入重点行业编码" v-model="model.keyIndustryCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/qyjbxx/qylszdhygx/qylszdhygx/queryById",
                  add: "/sptsjzx/qyaqjcgl/qyjbxx/qylszdhygx/qylszdhygx/add",
