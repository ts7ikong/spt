<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">装卸站台基础信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">站台建设日期：</text></view>
                  <input  placeholder="请输入站台建设日期" v-model="model.buildDate"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">站台投产日期：</text></view>
                  <input  placeholder="请输入站台投产日期" v-model="model.startDate"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">站台类型：</text></view>
                  <input  placeholder="请输入站台类型" v-model="model.platformType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/zxztjcxx/devicePlatform/queryById",
                  add: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/zxztjcxx/devicePlatform/add",
                  edit: "/sptsjzx/qyaqjcgl/zysbsssj/jcsbxx/zxztjcxx/devicePlatform/edit",
                },
            }
        },
        created(){
