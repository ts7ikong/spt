package org.jeecg.modules.sptsjzx.qyaqjcgl.qyjbxx.qyzdjggyxx.entity;
 ...
 */
@Data
@TableName("qyzdjggyxx")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="qyzdjggyxx对象", description="企业重点监管工艺信息")
public class Qyzdjggyxx implements Serializable {
