<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">危险源包保负责人信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">责任人类型：</text></view>
                  <input  placeholder="请输入责任人类型" v-model="model.responsibleType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">负责人姓名：</text></view>
                  <input  placeholder="请输入负责人姓名" v-model="model.responsible"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">负责人电话：</text></view>
                  <input  placeholder="请输入负责人电话" v-model="model.responsiblePhone"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">负责人职务：</text></view>
                  <input  placeholder="请输入负责人职务" v-model="model.responsiblePost"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">负责人职责：</text></view>
                  <input  placeholder="请输入负责人职责" v-model="model.responsibleDuty"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/qyaqjcgl/qyjbxx/wxybbzrrxx/wxybbfzrxx/queryById",
                  add: "/sptsjzx/qyaqjcgl/qyjbxx/wxybbzrrxx/wxybbfzrxx/add",
                  edit: "/sptsjzx/qyaqjcgl/qyjbxx/wxybbzrrxx/wxybbfzrxx/edit",
                },
            }
        },
        created(){
