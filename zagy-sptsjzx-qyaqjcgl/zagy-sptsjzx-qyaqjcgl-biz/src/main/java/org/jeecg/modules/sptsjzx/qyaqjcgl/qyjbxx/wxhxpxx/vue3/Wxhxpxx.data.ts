...
export const searchFormSchema: FormSchema[] = [
	{
      ...
      componentProps:{
         dict:"v_accept_company,name,name"
      },
      //colProps: {span: 6},
 	},
	{
...
export const superQuerySchema = {
  ...
  companyCode: {title: '企业名称',order: 1,view: 'sel_search', type: 'string',dictTable: "v_accept_company", dictCode: 'name', dictText: 'name',},
  hazardCode: {title: '危险源编码',order: 2,view: 'sel_search', type: 'string',dictTable: "v_accept_hazard_code", dictCode: 'hazard_code', dictText: 'hazard_name',},
