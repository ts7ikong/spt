package org.jeecg.modules.sptsjzx.qyaqjcgl.qyjbxx.wxybbzrrxx.entity;
 ...
 */
@Data
@TableName("wxybbfzrxx")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="wxybbfzrxx对象", description="危险源包保负责人信息")
public class Wxybbfzrxx implements Serializable {
	...
	/**责任人类型*/
	@Excel(name = "责任人类型", width = 15, dicCode = "zrrlx")
	@Dict(dicCode = "zrrlx")
    @ApiModelProperty(value = "责任人类型")
    private java.lang.String responsibleType;
	/**负责人姓名*/
	...
	/**负责人职务*/
	@Excel(name = "负责人职务", width = 15)
    @ApiModelProperty(value = "负责人职务")
    private java.lang.String responsiblePost;
	/**负责人职责*/
	@Excel(name = "负责人职责", width = 15)
    @ApiModelProperty(value = "负责人职责")
    private java.lang.String responsibleDuty;
	/**删除标志*/
