<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">岗位操作卡</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">作业程序：</text></view>
                  <input  placeholder="请输入作业程序" v-model="model.program"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">作业标准及注意事项：</text></view>
                  <input  placeholder="请输入作业标准及注意事项" v-model="model.attention"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">作业顺序：</text></view>
                  <input type="number" placeholder="请输入作业顺序" v-model="model.index"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
...
<script>
    ...
    export default {
        name: "AcceptOperationFormalForm",
        components:{ myDate },
        props:{
          formData:{
              type:Object,
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/scyf/gwczk/acceptOperationFormal/queryById",
                  add: "/sptsjzx/scyf/gwczk/acceptOperationFormal/add",
                  edit: "/sptsjzx/scyf/gwczk/acceptOperationFormal/edit",
                },
            }
        },
        created(){
