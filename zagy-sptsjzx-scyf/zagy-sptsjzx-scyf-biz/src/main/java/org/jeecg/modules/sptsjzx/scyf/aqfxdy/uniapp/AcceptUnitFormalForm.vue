<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">安全风险单元</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">第三方企业的uuid：</text></view>
                  <input  placeholder="请输入第三方企业的uuid" v-model="model.uuid"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险分析单元名称：</text></view>
                  <input  placeholder="请输入风险分析单元名称" v-model="model.riskUnitName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/scyf/aqfxdy/acceptUnitFormal/queryById",
                  add: "/sptsjzx/scyf/aqfxdy/acceptUnitFormal/add",
                  edit: "/sptsjzx/scyf/aqfxdy/acceptUnitFormal/edit",
                },
            }
        },
        created(){
