<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">安全风险事件</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险事件名称：</text></view>
                  <input  placeholder="请输入风险事件名称" v-model="model.riskEventName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/scyf/aqfxsj/acceptEventFormal/queryById",
                  add: "/sptsjzx/scyf/aqfxsj/acceptEventFormal/add",
