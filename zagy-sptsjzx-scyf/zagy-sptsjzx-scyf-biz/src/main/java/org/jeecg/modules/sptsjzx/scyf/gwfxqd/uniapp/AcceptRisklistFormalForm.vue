<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">岗位风险清单</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险点名称：</text></view>
                  <input  placeholder="请输入风险点名称" v-model="model.risklistName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险等级：</text></view>
                  <input type="number" placeholder="请输入风险等级" v-model="model.risklistLevel"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险标志完整图片地址：</text></view>
                  <input  placeholder="请输入风险标志完整图片地址" v-model="model.risklistSafetymark"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">防控级别：</text></view>
                  <input type="number" placeholder="请输入防控级别" v-model="model.risklistPreventionlevel"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入危险和有害因素" v-model="model.risklistHarmful"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">风险事件：</text></view>
                  <input  placeholder="请输入风险事件" v-model="model.risklistConsequence"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">管控措施：</text></view>
                  <input  placeholder="请输入管控措施" v-model="model.risklistMeasure"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/scyf/gwfxqd/acceptRisklistFormal/queryById",
                  add: "/sptsjzx/scyf/gwfxqd/acceptRisklistFormal/add",
