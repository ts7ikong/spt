package org.jeecg.modules.sptsjzx.scyf.gwzzqd.entity;
 ...
 */
@Data
@TableName("accept_duty_formal")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="accept_duty_formal对象", description="岗位职责清单")
public class AcceptDutyFormal implements Serializable {
