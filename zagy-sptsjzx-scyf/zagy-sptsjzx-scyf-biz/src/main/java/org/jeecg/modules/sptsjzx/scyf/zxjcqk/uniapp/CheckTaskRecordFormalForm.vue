    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">任务编号：</text></view>
                  <input  placeholder="请输入任务编号" v-model="model.taskId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">检查日期：</text></view>
                  <input  placeholder="请输入检查日期" v-model="model.checkDate"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">是否停产整顿：</text></view>
                  <input  placeholder="请输入是否停产整顿" v-model="model.resultStatus"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/scyf/zxjcqk/checkTaskRecordFormal/queryById",
                  add: "/sptsjzx/scyf/zxjcqk/checkTaskRecordFormal/add",
