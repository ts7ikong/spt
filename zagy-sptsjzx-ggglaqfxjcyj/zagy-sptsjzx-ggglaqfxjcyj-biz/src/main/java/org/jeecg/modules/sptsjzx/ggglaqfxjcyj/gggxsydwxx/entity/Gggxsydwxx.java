package org.jeecg.modules.sptsjzx.ggglaqfxjcyj.gggxsydwxx.entity;
 ...
 */
@Data
@TableName("gggxsydwxx")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="gggxsydwxx对象", description="公共管线使用单位信息")
public class Gggxsydwxx implements Serializable {
	...
	/**管线使用单位编号*/
	@Excel(name = "管线使用单位编号", width = 15)
    @ApiModelProperty(value = "管线使用单位编号")
    private java.lang.String useCode;
	/**所属单位编号*/
	@Excel(name = "所属单位编号", width = 15)
	...
	/**使用类型*/
	@Excel(name = "使用类型", width = 15, dicCode = "sylx")
	@Dict(dicCode = "sylx")
