<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">公共管架基础信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">管架编号：</text></view>
                  <input  placeholder="请输入管架编号" v-model="model.pipeframeCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">管架名称：</text></view>
                  <input  placeholder="请输入管架名称" v-model="model.pipeframeName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">管架类型：</text></view>
                  <input  placeholder="请输入管架类型" v-model="model.pipeframeType"/>
                </view>
              </view>
              <my-date label="投用日期：" v-model="model.pipeframeUdate" placeholder="请输入投用日期"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">地理位置信息：</text></view>
                  <input  placeholder="请输入地理位置信息" v-model="model.pipeframeGlocation"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">状态：</text></view>
                  <input  placeholder="请输入状态" v-model="model.pipeframeState"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">备注：</text></view>
                  <input  placeholder="请输入备注" v-model="model.pipeframeRemarks"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">资料附件：</text></view>
                  <input  placeholder="请输入资料附件" v-model="model.pipeframeInfomation"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/ggglaqfxjcyj/gggjjcxx/gggjjcxx/queryById",
                  add: "/sptsjzx/ggglaqfxjcyj/gggjjcxx/gggjjcxx/add",
                  edit: "/sptsjzx/ggglaqfxjcyj/gggjjcxx/gggjjcxx/edit",
                },
            }
        },
        created(){
