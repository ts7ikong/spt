package org.jeecg.modules.sptsjzx.zdwxyaqgl.xccc.ccqyjl.ccqyfkjl.entity;
...
@ApiModel(value="ccqyfkjl对象", description="抽查企业反馈记录")
public class Ccqyfkjl implements Serializable {
	...
	/**抽查企业记录ID*/
	@Excel(name = "抽查企业记录ID", width = 15)
    @ApiModelProperty(value = "抽查企业记录ID")
    private java.lang.String inspectCompanyId;
	/**巡查记录反馈的类型*/
	...
	/**延期日期*/
	@Excel(name = "延期日期", width = 20, format = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "延期日期")
    private java.util.Date delayDate;
	/**计划完成日期*/
	@Excel(name = "计划完成日期", width = 20, format = "yyyy-MM-dd HH:mm:ss")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd HH:mm:ss")
    @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss")
    @ApiModelProperty(value = "计划完成日期")
    private java.util.Date planDate;
	/**是否已完成*/
	@Excel(name = "是否已完成", width = 15)
