<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">巡查记录反馈</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">巡查记录ID：</text></view>
                  <input  placeholder="请输入巡查记录ID" v-model="model.inspectId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="延期日期：" fields="day" v-model="model.delayDate" placeholder="请输入延期日期"></my-date>
              <my-date label="计划完成日期：" fields="day" v-model="model.planDate" placeholder="请输入计划完成日期"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/zdwxyaqgl/xccc/xcjl/xcjlfk/xcjlfk/queryById",
                  add: "/sptsjzx/zdwxyaqgl/xccc/xcjl/xcjlfk/xcjlfk/add",
                  edit: "/sptsjzx/zdwxyaqgl/xccc/xcjl/xcjlfk/xcjlfk/edit",
                },
            }
        },
        created(){
