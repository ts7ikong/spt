...
public class CcqyjlsbController extends JeecgController<Ccqyjlsb, ICcqyjlsbService> {
	...
	public Result<IPage<Ccqyjlsb>> queryPageList(Ccqyjlsb ccqyjlsb,
		...
		if (!DataScopeHelper.needDataScope()) {
			...
			String requestCompanyCode = ccqyjlsb.getCompanyCode();
		...
		if (ccqyjlsb.getCountyCode() != null) {
			String orgCode = ccqyjlsb.getCountyCode();
			List<String> companyCodes = acceptCompanyService.getCompanyCodesByCountyCode(orgCode);
		...
		if (pageList != null && CollectionUtils.isNotEmpty(pageList.getRecords())) {
			for (Ccqyjlsb item : pageList.getRecords()) {
