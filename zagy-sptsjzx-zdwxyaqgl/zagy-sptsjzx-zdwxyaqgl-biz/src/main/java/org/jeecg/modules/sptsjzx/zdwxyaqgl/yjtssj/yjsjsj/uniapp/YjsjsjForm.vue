			...
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入预警等级" v-model="model.yjRank"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">预警描述：</text></view>
                  <input  placeholder="请输入预警描述" v-model="model.message"/>
                </view>
              </view>
              <my-date label="预警起始时间：" v-model="model.startTime" placeholder="请输入预警起始时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">预警状态：</text></view>
                  <input  placeholder="请输入预警状态" v-model="model.warnStatus"/>
                </view>
              </view>
              <my-date label="预警销警时间：" v-model="model.resumeTime" placeholder="请输入预警销警时间"></my-date>
              <my-date label="预警结束时间：" v-model="model.endTime" placeholder="请输入预警结束时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/zdwxyaqgl/yjtssj/yjsjsj/yjsjsj/queryById",
                  add: "/sptsjzx/zdwxyaqgl/yjtssj/yjsjsj/yjsjsj/add",
                  edit: "/sptsjzx/zdwxyaqgl/yjtssj/yjsjsj/yjsjsj/edit",
                },
            }
        },
        created(){
