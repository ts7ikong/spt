package org.jeecg.modules.sptsjzx.zdwxyaqgl.xccc.xtsyqk.xtyhdljl.controller;
...
public class XtyhdljlController extends JeecgController<Xtyhdljl, IXtyhdljlService> {
	...
	public Result<IPage<Xtyhdljl>> queryPageList(Xtyhdljl xtyhdljl,
        ...
        customeRuleMap.put("requestType", QueryRuleEnum.LIKE_WITH_OR);
    ...
    */
    ...
    public ModelAndView exportXls(HttpServletRequest request, Xtyhdljl xtyhdljl) {
        return super.exportXls(request, xtyhdljl, Xtyhdljl.class, "系统用户登录记录");
    }
    ...
    */
    ...
    public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        return super.importExcel(request, response, Xtyhdljl.class);
    }
