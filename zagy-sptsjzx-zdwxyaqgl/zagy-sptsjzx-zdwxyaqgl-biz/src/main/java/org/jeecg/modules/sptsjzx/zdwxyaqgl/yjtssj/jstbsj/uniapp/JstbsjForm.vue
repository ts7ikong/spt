<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">警示通报数据</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">警示通报编码：</text></view>
                  <input  placeholder="请输入警示通报编码" v-model="model.noticeCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">预警事件 ID：</text></view>
                  <input  placeholder="请输入预警事件 ID" v-model="model.warningId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">警示通报内容：</text></view>
                  <input  placeholder="请输入警示通报内容" v-model="model.content"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">原因：</text></view>
                  <input  placeholder="请输入原因" v-model="model.reason"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">发送方的组织编码：</text></view>
                  <input  placeholder="请输入发送方的组织编码" v-model="model.fromOrgCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">接收方的组织编码：</text></view>
                  <input  placeholder="请输入接收方的组织编码" v-model="model.toOrgCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/zdwxyaqgl/yjtssj/jstbsj/jstbsj/queryById",
                  add: "/sptsjzx/zdwxyaqgl/yjtssj/jstbsj/jstbsj/add",
