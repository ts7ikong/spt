...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入巡查记录ID!'},
          ];
     },
  },
  {
...
export const superQuerySchema = {
  ...
  inspectId: {title: '巡查记录ID',order: 1,view: 'text', type: 'string',},
  ...
  delayDate: {title: '延期日期',order: 7,view: 'date', type: 'string',},
  planDate: {title: '计划完成日期',order: 8,view: 'date', type: 'string',},
  isFinish: {title: '是否已完成',order: 9,view: 'list', type: 'string',dictCode: 'sfywc',},
  status: {title: '删除标记',order: 10,view: 'list', type: 'string',dictCode: '',},
