<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">抽查企业反馈记录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">抽查企业记录ID：</text></view>
                  <input  placeholder="请输入抽查企业记录ID" v-model="model.inspectCompanyId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">巡查记录反馈的类型：</text></view>
                  <input  placeholder="请输入巡查记录反馈的类型" v-model="model.replyType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">补充信息：</text></view>
                  <input  placeholder="请输入补充信息" v-model="model.otherInfo"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="延期日期：" v-model="model.delayDate" placeholder="请输入延期日期"></my-date>
              <my-date label="计划完成日期：" v-model="model.planDate" placeholder="请输入计划完成日期"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">是否已完成：</text></view>
                  <input  placeholder="请输入是否已完成" v-model="model.isFinish"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/zdwxyaqgl/xccc/ccqyjl/ccqyfkjl/ccqyfkjl/queryById",
                  add: "/sptsjzx/zdwxyaqgl/xccc/ccqyjl/ccqyfkjl/ccqyfkjl/add",
                  edit: "/sptsjzx/zdwxyaqgl/xccc/ccqyjl/ccqyfkjl/ccqyfkjl/edit",
                },
            }
        },
        created(){
