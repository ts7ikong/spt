package org.jeecg.modules.sptsjzx.zdwxyaqgl.xccc.xcjl.xcjl.entity;
...
@ApiModel(value="xcjl对象", description="巡查记录")
public class Xcjl implements Serializable {
	...
	/**近24小时未销警指标数*/
	@Excel(name = "近24小时未销警指标数", width = 15)
    @ApiModelProperty(value = "近24小时未销警指标数")
