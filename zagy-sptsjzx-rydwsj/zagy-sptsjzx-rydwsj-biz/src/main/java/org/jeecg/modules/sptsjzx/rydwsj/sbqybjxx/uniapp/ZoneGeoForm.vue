<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">上报区域边界信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">边界名称：</text></view>
                  <input  placeholder="请输入边界名称" v-model="model.zoneName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">区域类型：</text></view>
                  <input type="number" placeholder="请输入区域类型" v-model="model.zoneType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">边界信息：</text></view>
                  <input  placeholder="请输入边界信息" v-model="model.geo"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/rydwsj/sbqybjxx/zoneGeo/queryById",
                  add: "/sptsjzx/rydwsj/sbqybjxx/zoneGeo/add",
