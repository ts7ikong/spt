package org.jeecg.modules.sptsjzx.rydwsj.sbrybjsj.entity;
...
@ApiModel(value = "rybjsj对象", description = "上报人员报警数据")
public class Rybjsj implements Serializable {
