...
export const superQuerySchema = {
  ...
  zoneId: {title: '区域边界',order: 2,view: 'sel_search', type: 'string',dictTable: "zone_geo", dictCode: 'uuid', dictText: 'zone_name',},
  alarmType: {title: '报警类型',order: 3,view: 'list', type: 'string',dictCode: 'rydwbjlx',},
  alarmTime: {title: '报警时间',order: 4,view: 'date', type: 'string',},
  dispelTime: {title: '销警时间',order: 5,view: 'date', type: 'string',},
  describex: {title: '报警描述',order: 6,view: 'text', type: 'string',},
};
