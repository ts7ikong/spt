...
//    List<JSONObject> queryDepartsByOrgIds(@RequestParam("ids") String ids);
     ...
     * @param yqjbxxDTO
     */
    @PostMapping("/sys/api/xzyqyhxxToUser")
    void xzyqyhxxToUser(@RequestBody YqjbxxDTO yqjbxxDTO);
     ...
     * @param yqjbxxDTO
     */
    @PostMapping("/sys/api/scyqyhxxToUser")
    void scyqyhxxToUser(@RequestBody YqjbxxDTO yqjbxxDTO);
}
