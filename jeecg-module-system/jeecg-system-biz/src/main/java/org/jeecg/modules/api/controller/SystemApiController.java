...
//        }
     ...
     * @param yqjbxxDTO
     */
    @PostMapping("/xzyqyhxxToUser")
    public void xzyqyhxxToUser(@RequestBody YqjbxxDTO yqjbxxDTO){
        this.sysBaseApi.xzyqyhxxToUser(yqjbxxDTO);
    }
     ...
     * @param yqjbxxDTO
     */
    @PostMapping("/scyqyhxxToUser")
    public void scyqyhxxToUser(@RequestBody YqjbxxDTO yqjbxxDTO){
        this.sysBaseApi.scyqyhxxToUser(yqjbxxDTO);
    }
