<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">第三方单位资质信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">第三方单位社 会统一信用代 码：</text></view>
                  <input  placeholder="请输入第三方单位社 会统一信用代 码" v-model="model.socialcode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="有效期起：" v-model="model.starttime" placeholder="请输入有效期起"></my-date>
              <my-date label="有效期止：" v-model="model.endtime" placeholder="请输入有效期止"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwzzxx/dsfdwzzxx/queryById",
                  add: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwzzxx/dsfdwzzxx/add",
                  edit: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwzzxx/dsfdwzzxx/edit",
                },
            }
        },
        created(){
