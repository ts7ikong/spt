<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">装置大检修备案</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <my-date label="大检修开始时间：" v-model="model.maintenanceStartTime" placeholder="请输入大检修开始时间"></my-date>
              <my-date label="大检修实际结束时间：" v-model="model.maintenanceEndTime" placeholder="请输入大检修实际结束时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="大检修计划结束时间：" v-model="model.maintenanceExpireTime" placeholder="请输入大检修计划结束时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/zzktchdjxgl/zzdjxba/zzdjxba/queryById",
                  add: "/sptsjzx/aqjcgl/zzktchdjxgl/zzdjxba/zzdjxba/add",
