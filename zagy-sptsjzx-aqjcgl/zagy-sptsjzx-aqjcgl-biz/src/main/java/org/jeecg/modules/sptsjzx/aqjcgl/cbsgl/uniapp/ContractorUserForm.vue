<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">承包商人员</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入姓名" v-model="model.personName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">人员编码：</text></view>
                  <input  placeholder="请输入人员编码" v-model="model.ersonCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">身份证号：</text></view>
                  <input  placeholder="请输入身份证号" v-model="model.idCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">是否高风险岗位：</text></view>
                  <input  placeholder="请输入是否高风险岗位" v-model="model.highRiskPosition"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">员工照片：</text></view>
                  <input  placeholder="请输入员工照片" v-model="model.personPicture"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">证书名称：</text></view>
                  <input  placeholder="请输入证书名称" v-model="model.certificateName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">证书号码：</text></view>
                  <input  placeholder="请输入证书号码" v-model="model.certificateNumber"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">证书级别：</text></view>
                  <input  placeholder="请输入证书级别" v-model="model.certificateLevel"/>
                </view>
              </view>
              <my-date label="证书有效期起：" fields="day" v-model="model.starttime" placeholder="请输入证书有效期起"></my-date>
              <my-date label="证书有效期止：" fields="day" v-model="model.endtime" placeholder="请输入证书有效期止"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/cbsgl/contractorUser/queryById",
                  add: "/sptsjzx/aqjcgl/cbsgl/contractorUser/add",
                  edit: "/sptsjzx/aqjcgl/cbsgl/contractorUser/edit",
                },
            }
        },
        created(){
