<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">第三方单位安全教育培训记录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <my-date label="培训时间：" v-model="model.trainingTime" placeholder="请输入培训时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwaqjypxjl/dsfdwaqjypxjl/queryById",
                  add: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwaqjypxjl/dsfdwaqjypxjl/add",
