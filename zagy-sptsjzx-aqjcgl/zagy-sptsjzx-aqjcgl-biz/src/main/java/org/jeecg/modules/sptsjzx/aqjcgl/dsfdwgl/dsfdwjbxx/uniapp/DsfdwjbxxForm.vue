    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">第三方单位社会统一信用代码：</text></view>
                  <input  placeholder="请输入第三方单位社会统一信用代码" v-model="model.socialCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">第三方单位类型：</text></view>
                  <input  placeholder="请输入第三方单位类型" v-model="model.companyType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">上报企业编码：</text></view>
                  <input  placeholder="请输入上报企业编码" v-model="model.reportCompanyCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="服务期限起：" v-model="model.serviceStart" placeholder="请输入服务期限起"></my-date>
              <my-date label="服务期限止：" v-model="model.serviceEnd" placeholder="请输入服务期限止"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwjbxx/dsfdwjbxx/queryById",
                  add: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwjbxx/dsfdwjbxx/add",
                  edit: "/sptsjzx/aqjcgl/dsfdwgl/dsfdwjbxx/dsfdwjbxx/edit",
                },
            }
        },
        created(){
