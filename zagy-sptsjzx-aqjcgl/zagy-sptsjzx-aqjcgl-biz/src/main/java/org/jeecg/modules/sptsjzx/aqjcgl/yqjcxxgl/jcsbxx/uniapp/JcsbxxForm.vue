<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">监测设备信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">设备描述：</text></view>
                  <input  placeholder="请输入设备描述" v-model="model.equipDescribe"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">设备类型：</text></view>
                  <input  placeholder="请输入设备类型" v-model="model.equipType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">设备运行状态：</text></view>
                  <input  placeholder="请输入设备运行状态" v-model="model.equipStatus"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入更新日期_企业" v-model="model.updateByCompany"/>
                </view>
              </view>
				<view class="padding">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/yqjcxxgl/jcsbxx/jcsbxx/queryById",
                  add: "/sptsjzx/aqjcgl/yqjcxxgl/jcsbxx/jcsbxx/add",
                  edit: "/sptsjzx/aqjcgl/yqjcxxgl/jcsbxx/jcsbxx/edit",
                },
            }
        },
        created(){
