package org.jeecg.modules.sptsjzx.aqjcgl.dsfdwgl.dsfdwwgjl.entity;
...
@ApiModel(value="dsfdwwgjl对象", description="第三方单位违规记录")
public class Dsfdwwgjl implements Serializable {
