<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">承包商培训记录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入身份证号" v-model="model.idCard"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入培训成绩" v-model="model.trainingResult"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/aqjcgl/cbsgl/contractorTrain/queryById",
                  add: "/sptsjzx/aqjcgl/cbsgl/contractorTrain/add",
                  edit: "/sptsjzx/aqjcgl/cbsgl/contractorTrain/edit",
                },
            }
        },
        created(){
