<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">第三方违规记录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">违规发生地点：</text></view>
                  <input  placeholder="请输入违规发生地点" v-model="model.place"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">违规描述内容：</text></view>
                  <input  placeholder="请输入违规描述内容" v-model="model.disposeDesc"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">处理过程描述：</text></view>
                  <input  placeholder="请输入处理过程描述" v-model="model.disposeProcess"/>
                </view>
              </view>
              <my-date label="违规发生时间：" fields="day" v-model="model.startTime" placeholder="请输入违规发生时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/dsfdwgl/dsfwgjl/contractorViolationRecord/queryById",
                  add: "/sptsjzx/dsfdwgl/dsfwgjl/contractorViolationRecord/add",
