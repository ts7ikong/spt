package org.jeecg.modules.sptsjzx.dsfdwgl.dsfzzxx.controller;
...
@Api(tags="第三方资质信息")
@RestController
@RequestMapping("/sptsjzx/dsfdwgl/dsfzzxx/contractorQualificationInfo")
@Slf4j
public class ContractorQualificationInfoController extends JeecgController<ContractorQualificationInfo, IContractorQualificationInfoService> {
	 ...
	 * @return
	 */
	//@AutoLog(value = "第三方资质信息-分页列表查询")
	@ApiOperation(value="第三方资质信息-分页列表查询", notes="第三方资质信息-分页列表查询")
	...
	public Result<IPage<ContractorQualificationInfo>> queryPageList(ContractorQualificationInfo contractorQualificationInfo,
        ...
        QueryWrapper<ContractorQualificationInfo> queryWrapper = QueryGenerator.initQueryWrapper(contractorQualificationInfo, req.getParameterMap());
		...
		if (!DataScopeHelper.needDataScope()) {
			...
			String requestCompanyCode = contractorQualificationInfo.getSocialCode();
	 ...
	 * @return
	 */
	@AutoLog(value = "第三方资质信息-添加")
	@ApiOperation(value="第三方资质信息-添加", notes="第三方资质信息-添加")
	@RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:add")
	 ...
	 * @return
	 */
	@AutoLog(value = "第三方资质信息-编辑")
	@ApiOperation(value="第三方资质信息-编辑", notes="第三方资质信息-编辑")
	@RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:edit")
	 ...
	 * @return
	 */
	@AutoLog(value = "第三方资质信息-通过id删除")
	@ApiOperation(value="第三方资质信息-通过id删除", notes="第三方资质信息-通过id删除")
	@RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:delete")
	 ...
	 * @return
	 */
	@AutoLog(value = "第三方资质信息-批量删除")
	@ApiOperation(value="第三方资质信息-批量删除", notes="第三方资质信息-批量删除")
	@RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:deleteBatch")
	 ...
	 * @return
	 */
	//@AutoLog(value = "第三方资质信息-通过id查询")
	@ApiOperation(value="第三方资质信息-通过id查询", notes="第三方资质信息-通过id查询")
    ...
    * @param contractorQualificationInfo
    */
    @RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:exportXls")
    @RequestMapping(value = "/exportXls")
    public ModelAndView exportXls(HttpServletRequest request, ContractorQualificationInfo contractorQualificationInfo) {
        return super.exportXls(request, contractorQualificationInfo, ContractorQualificationInfo.class, "第三方资质信息");
    }
    ...
    * @return
    */
    @RequiresPermissions("sptsjzx.dsfdwgl.dsfzzxx:contractor_qualification_info:importExcel")
