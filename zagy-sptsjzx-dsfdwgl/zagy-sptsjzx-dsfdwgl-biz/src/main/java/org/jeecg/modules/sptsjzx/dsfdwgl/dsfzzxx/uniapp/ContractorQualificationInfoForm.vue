<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">第三方资质信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/dsfdwgl/dsfzzxx/contractorQualificationInfo/queryById",
                  add: "/sptsjzx/dsfdwgl/dsfzzxx/contractorQualificationInfo/add",
