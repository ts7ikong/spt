<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">医疗资源信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">机构编码：</text></view>
                  <input  placeholder="请输入机构编码" v-model="model.institutionId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">机构名称：</text></view>
                  <input  placeholder="请输入机构名称" v-model="model.institutionName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">机构类别：</text></view>
                  <input  placeholder="请输入机构类别" v-model="model.institutionType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">机构等级：</text></view>
                  <input  placeholder="请输入机构等级" v-model="model.institutionLevel"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/mjyj/yjzysj/ylzyxx/ylzyxx/queryById",
                  add: "/sptsjzx/mjyj/yjzysj/ylzyxx/ylzyxx/add",
                  edit: "/sptsjzx/mjyj/yjzysj/ylzyxx/ylzyxx/edit",
                },
            }
        },
        created(){
