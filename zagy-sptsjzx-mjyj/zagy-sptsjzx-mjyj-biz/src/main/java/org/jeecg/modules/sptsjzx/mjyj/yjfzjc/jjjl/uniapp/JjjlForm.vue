    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">接警人：</text></view>
                  <input  placeholder="请输入接警人" v-model="model.pickUpPerson"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">报警人：</text></view>
                  <input  placeholder="请输入报警人" v-model="model.callThePolice"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">报警电话：</text></view>
                  <input  placeholder="请输入报警电话" v-model="model.policeCall"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">事故装置：</text></view>
                  <input  placeholder="请输入事故装置" v-model="model.accidentDevice"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">涉及危险化学品：</text></view>
                  <input  placeholder="请输入涉及危险化学品" v-model="model.hazardousChemicals"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">关联企业编码：</text></view>
                  <input  placeholder="请输入关联企业编码" v-model="model.affiliates"/>
                </view>
              </view>
              <my-date label="接警时间：" fields="day" v-model="model.policeTime" placeholder="请输入接警时间"></my-date>
              <my-date label="事故发生时间：" fields="day" v-model="model.startTime" placeholder="请输入事故发生时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">死亡人数：</text></view>
                  <input type="number" placeholder="请输入死亡人数" v-model="model.deathToll"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">重伤人数：</text></view>
                  <input type="number" placeholder="请输入重伤人数" v-model="model.seriouslyInjuredNumber"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">轻伤人数：</text></view>
                  <input type="number" placeholder="请输入轻伤人数" v-model="model.minorInjuriesNumber"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">已采取措施：</text></view>
                  <input  placeholder="请输入已采取措施" v-model="model.accidentOverview"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/mjyj/yjfzjc/jjjl/jjjl/queryById",
                  add: "/sptsjzx/mjyj/yjfzjc/jjjl/jjjl/add",
                  edit: "/sptsjzx/mjyj/yjfzjc/jjjl/jjjl/edit",
                },
            }
        },
        created(){
