    ...
    <view>
		...
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">专家编码：</text></view>
                  <input  placeholder="请输入专家编码" v-model="model.expertId"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">专家姓名：</text></view>
                  <input  placeholder="请输入专家姓名" v-model="model.expertName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="出生年月：" fields="day" v-model="model.dateOfBirth" placeholder="请输入出生年月"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入专业" v-model="model.major"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">职称：</text></view>
                  <input  placeholder="请输入职称" v-model="model.title"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">电子邮箱：</text></view>
                  <input  placeholder="请输入电子邮箱" v-model="model.email"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/mjyj/yjzysj/yjzjxx/yjzjxx/queryById",
                  add: "/sptsjzx/mjyj/yjzysj/yjzjxx/yjzjxx/add",
