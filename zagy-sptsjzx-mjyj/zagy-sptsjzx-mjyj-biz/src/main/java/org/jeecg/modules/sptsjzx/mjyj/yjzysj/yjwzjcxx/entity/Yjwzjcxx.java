package org.jeecg.modules.sptsjzx.mjyj.yjzysj.yjwzjcxx.entity;
...
@ApiModel(value="yjwzjcxx对象", description="应急物资基础信息")
public class Yjwzjcxx implements Serializable {
    ...
    private java.lang.String materialUse;
	/**存储和运输要求*/
	@Excel(name = "存储和运输要求", width = 15)
    @ApiModelProperty(value = "存储和运输要求")
    private java.lang.String storageTransportRequirement;
	/**所属单位*/
