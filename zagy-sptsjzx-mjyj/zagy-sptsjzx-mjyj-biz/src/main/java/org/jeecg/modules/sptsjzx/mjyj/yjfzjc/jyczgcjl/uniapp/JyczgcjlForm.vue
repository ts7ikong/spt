<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">救援处置过程记录</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">现场救援行动编号：</text></view>
                  <input  placeholder="请输入现场救援行动编号" v-model="model.rescueCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">记录人：</text></view>
                  <input  placeholder="请输入记录人" v-model="model.rwcordName"/>
                </view>
              </view>
              <my-date label="记录时间：" v-model="model.rwcordTime" placeholder="请输入记录时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">救援会议纪要：</text></view>
                  <input  placeholder="请输入救援会议纪要" v-model="model.summary"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">调用物资、人员情况：</text></view>
                  <input  placeholder="请输入调用物资、人员情况" v-model="model.materialSituation"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/mjyj/yjfzjc/jyczgcjl/jyczgcjl/queryById",
                  add: "/sptsjzx/mjyj/yjfzjc/jyczgcjl/jyczgcjl/add",
                  edit: "/sptsjzx/mjyj/yjfzjc/jyczgcjl/jyczgcjl/edit",
                },
            }
        },
        created(){
