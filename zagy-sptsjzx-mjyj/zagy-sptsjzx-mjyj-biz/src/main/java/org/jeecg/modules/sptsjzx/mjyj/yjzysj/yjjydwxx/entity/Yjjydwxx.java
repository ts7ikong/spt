package org.jeecg.modules.sptsjzx.mjyj.yjzysj.yjjydwxx.entity;
...
@ApiModel(value="yjjydwxx对象", description="应急救援队伍信息")
public class Yjjydwxx implements Serializable {
	...
	/**队伍分类*/
	@Excel(name = "队伍分类", width = 15, dicCode = "dwfl")
	@Dict(dicCode = "dwfl")
    @ApiModelProperty(value = "队伍分类")
