<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">危化品车辆实时定位</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">定位终端编码：</text></view>
                  <input  placeholder="请输入定位终端编码" v-model="model.locaterCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入位置描述" v-model="model.address"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <my-date label="定位时间：" v-model="model.locatingTime" placeholder="请输入定位时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/fbhgl/dwxxgl/whpclssdw/whpclssdw/queryById",
                  add: "/sptsjzx/fbhgl/dwxxgl/whpclssdw/whpclssdw/add",
                  edit: "/sptsjzx/fbhgl/dwxxgl/whpclssdw/whpclssdw/edit",
                },
            }
        },
        created(){
