<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">其他车辆信息</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">驾驶证：</text></view>
                  <input  placeholder="请输入驾驶证" v-model="model.vehicleLicense"/>
                </view>
              </view>
              <my-date label="有效期起：" fields="day" v-model="model.lenStartDate" placeholder="请输入有效期起"></my-date>
              <my-date label="有效期止：" fields="day" v-model="model.lenEndDate" placeholder="请输入有效期止"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">所属企业编码：</text></view>
                  <input  placeholder="请输入所属企业编码" v-model="model.companyCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/qtclxx/qtclxx/queryById",
                  add: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/qtclxx/qtclxx/add",
                  edit: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/qtclxx/qtclxx/edit",
                },
            }
        },
        created(){
