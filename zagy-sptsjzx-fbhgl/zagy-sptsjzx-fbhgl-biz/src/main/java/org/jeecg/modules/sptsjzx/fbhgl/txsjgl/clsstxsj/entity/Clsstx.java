package org.jeecg.modules.sptsjzx.fbhgl.txsjgl.clsstxsj.entity;
...
@ApiModel(value="clsstx对象", description="车辆实时通行")
public class Clsstx implements Serializable {
	...
	/**车辆类型*/
	@Excel(name = "车辆类型", width = 15, dicCode = "txsjcllx")
	@Dict(dicCode = "txsjcllx")
