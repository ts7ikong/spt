package org.jeecg.modules.sptsjzx.fbhgl.mjkkglxxjcxxgl.whpyscltccxx.entity;
 ...
 */
@Data
@TableName("whpyscltccxx")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="whpyscltccxx对象", description="危化品运输车辆停车场信息")
public class Whpyscltccxx implements Serializable {
	...
	/**空载车位数*/
	@Excel(name = "空载车位数", width = 15)
    @ApiModelProperty(value = "空载车位数")
    private java.lang.Integer emptyLotNum;
	/**重载车位数*/
	@Excel(name = "重载车位数", width = 15)
    @ApiModelProperty(value = "重载车位数")
    private java.lang.Integer heavyLotNum;
	/**开放状态*/
	@Excel(name = "开放状态", width = 15, dicCode = "tcckfzt")
	@Dict(dicCode = "tcckfzt")
