package org.jeecg.modules.sptsjzx.fbhgl.dwxxgl.whpclssdw.entity;
...
@ApiModel(value="whpclssdw对象", description="危化品车辆实时定位")
public class Whpclssdw implements Serializable {
	...
	/**定位终端编码*/
	@Excel(name = "定位终端编码", width = 15)
    @ApiModelProperty(value = "定位终端编码")
    private java.lang.String locaterCode;
	/**车牌号码*/
    ...
    private java.util.Date locatingTime;
	/**创建日期*/
