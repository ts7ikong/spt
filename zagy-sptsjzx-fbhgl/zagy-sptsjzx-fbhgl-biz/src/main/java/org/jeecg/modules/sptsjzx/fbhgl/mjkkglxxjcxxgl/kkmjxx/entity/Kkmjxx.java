package org.jeecg.modules.sptsjzx.fbhgl.mjkkglxxjcxxgl.kkmjxx.entity;
...
@ApiModel(value="kkmjxx对象", description="卡口/门禁信息")
public class Kkmjxx implements Serializable {
	...
	/**设备类型*/
	@Excel(name = "设备类型", width = 15, dicCode = "kkmjsblx")
	@Dict(dicCode = "kkmjsblx")
