			...
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入人员姓名" v-model="model.staffName"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">人员类型：</text></view>
                  <input  placeholder="请输入人员类型" v-model="model.staffType"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入职位名称" v-model="model.staffPosition"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">性别：</text></view>
                  <input  placeholder="请输入性别" v-model="model.staffGender"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">专业：</text></view>
                  <input  placeholder="请输入专业" v-model="model.staffMajor"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">证件号码：</text></view>
                  <input  placeholder="请输入证件号码" v-model="model.idCard"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">其他证件：</text></view>
                  <input  placeholder="请输入其他证件" v-model="model.papers"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/fkxx/fkxx/queryById",
                  add: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/fkxx/fkxx/add",
                  edit: "/sptsjzx/fbhgl/mjkkglxxjcxxgl/fkxx/fkxx/edit",
                },
            }
        },
        created(){
