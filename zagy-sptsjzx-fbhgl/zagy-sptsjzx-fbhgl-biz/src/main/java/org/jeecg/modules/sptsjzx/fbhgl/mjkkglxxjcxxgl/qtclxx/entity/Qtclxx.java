package org.jeecg.modules.sptsjzx.fbhgl.mjkkglxxjcxxgl.qtclxx.entity;
...
@ApiModel(value="qtclxx对象", description="其他车辆信息")
public class Qtclxx implements Serializable {
	...
	/**所属企业编码*/
	@Excel(name = "所属企业编码", width = 15)
    @ApiModelProperty(value = "所属企业编码")
    private java.lang.String companyCode;
	/**车辆类型*/
	@Excel(name = "车辆类型", width = 15, dicCode = "cllx")
	@Dict(dicCode = "cllx")
