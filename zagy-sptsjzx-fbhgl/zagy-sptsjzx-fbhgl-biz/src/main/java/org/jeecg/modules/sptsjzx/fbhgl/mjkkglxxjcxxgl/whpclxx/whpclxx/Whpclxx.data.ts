...
export const formSchema: FormSchema[] = [
  ...
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入行驶证有效期起!'},
          ];
     },
  },
  {
    ...
    dynamicRules: ({model,schema}) => {
          return [
                 { required: true, message: '请输入行驶证有效期止!'},
          ];
     },
  },
  {
...
export const superQuerySchema = {
  ...
  vehicleLicense: {title: '行驶证',order: 7,view: 'text', type: 'string',},
  lenStartDate: {title: '行驶证有效期起',order: 8,view: 'date', type: 'string',},
  lenEndDate: {title: '行驶证有效期止',order: 9,view: 'date', type: 'string',},
  whetherLen: {title: '是否有效',order: 10,view: 'list', type: 'string',dictCode: 'sfbz',},
  companyCode: {title: '所属运输企业编码',order: 11,view: 'text', type: 'string',},
  roadTransportCode: {title: '道路运输证号',order: 12,view: 'text', type: 'string',},
