<template>
    <view>
		...
		<cu-custom :bgColor="NavBarColor" isBack :backRouterName="backRouteName">
			...
			<block slot="content">设备报警数据</block>
		</cu-custom>
		 <!--表单区域-->
		<view>
			<form>
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">报警编码：</text></view>
                  <input  placeholder="请输入报警编码" v-model="model.alarmCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">报警设备编码：</text></view>
                  <input  placeholder="请输入报警设备编码" v-model="model.deviceCode"/>
                </view>
              </view>
              <view class="cu-form-group">
                <view class="flex align-center">
                  <view class="title"><text space="ensp">报警设备类型：</text></view>
                  <input  placeholder="请输入报警设备类型" v-model="model.deviceType"/>
                </view>
              </view>
              <my-date label="报警时间：" v-model="model.alarmStartTime" placeholder="请输入报警时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
              ...
              <view class="cu-form-group">
                <view class="flex align-center">
                  ...
                  <input  placeholder="请输入处置状态" v-model="model.alarmStatus"/>
                </view>
              </view>
              <my-date label="处置时间：" v-model="model.alarmEndTime" placeholder="请输入处置时间"></my-date>
              <view class="cu-form-group">
                <view class="flex align-center">
    ...
    export default {
        ...
        data(){
            return {
                ...
                backRouteName:'index',
                url: {
                  queryById: "/sptsjzx/fbhgl/bjsj/sbbjsj/sbbjsj/queryById",
                  add: "/sptsjzx/fbhgl/bjsj/sbbjsj/sbbjsj/add",
