...
export const superQuerySchema = {
  ...
  equipmentCode: {title: '设备编码',order: 2,view: 'text', type: 'string',},
  staffCode: {title: '人员编码',order: 3,view: 'text', type: 'string',},
  staffType: {title: '人员类型',order: 4,view: 'list', type: 'string',dictCode: 'txrylx',},
  passTime: {title: '通行时间',order: 5,view: 'datetime', type: 'string',},
  passType: {title: '通行类型',order: 6,view: 'list', type: 'string',dictCode: 'txlx',},
  passImg: {title: '通行抓拍',order: 7,view: 'text', type: 'string',},
